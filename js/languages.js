...
let LANGS = {
  ...
  en: {
    ...
    readmore: "Read More",
    note1: "We work with individuals of all genders.",
    title9: "How we work?",
    ...
    qu4: "Can I change my body in a short time?",
    desc17:
    ...
    desc18: "Yes, you can change your body in a short time by making significant changes to your lifestyle and habits. By adopting a healthy diet, engaging in regular physical activity, getting enough sleep, and managing stress, you can achieve noticeable changes in your body shape, weight, and overall health within a few weeks or months.",
    ...
    calling: "call us : ",
    title18: "our works",
    title19: "Transforamations we do it ",
  },
  ...
  ar: {
    ...
    title1: "إطلاق الإمكانات الرياضية: قابل مدرب أسامة بوخ ",
    desc1:
      "أسامة بوخ مدرب رياضي مهر وخبير بفضل تجربته الطويلة ساعد العديد من الرياضيين على تحقيق أهدافهم . ملتزم باللياقة البدنية ولديه فهم عميق للجسم البشري، قدم حياته لمساعدة الناس على تحسين قدراتهم البدنية والوصول إلى مستويات جديدة في سعيهم الرياضي ",
    ...
    title4: 'خدماتنا : ',
    title5: "الخدمات التي نوفرها لزبنائنا ",
    ...
    note1: "نحن نعمل مع الرجال والنساء على حد سواء.",
    desc10:
